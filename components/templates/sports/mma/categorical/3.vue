...
export default {
  name: 'SportsMMACategoricalThree',
  ...
  computed: {
    ...
    calculatedOutComes () {
      const outcomes = ['[Fighter A] by KO/TKO', '[Fighter A] by Submission', '[Fighter A] by Points', '[Fighter B] by KO/TKO', '[Fighter B] by Submission', '[Fighter B] by Points', 'Draw/No Contest']

      if (this.fighterA) {
        outcomes[0] = `${this.fighterA} by KO/TKO`
        outcomes[1] = `${this.fighterA} by Submission`
        outcomes[2] = `${this.fighterA} by Points`
      }

      if (this.fighterB) {
        outcomes[3] = `${this.fighterB} by KO/TKO`
        outcomes[4] = `${this.fighterB} by Submission`
        outcomes[5] = `${this.fighterB} by Points`
      }
