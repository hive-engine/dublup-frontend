    ...
    <b-card title="Market question">
      <div class="market-question">
        ...
        <b-form-select
          ...
          :state="$v.rounds.$dirty ? !$v.rounds.$error : null"
        />.5 Rounds?
      </div>
    </b-card>
...
export default {
  ...
  computed: {
    ...
    calculatedOutComes () {
      ...
      if (this.rounds) {
        outcomes[0] = `Over ${this.rounds}`
        outcomes[1] = `Under ${this.rounds}`
      }
  ...
  validations: {
    ...
    form: ['fighterA', 'fighterB', 'rounds', 'startDate', 'startTime']
  }
}
</script>
