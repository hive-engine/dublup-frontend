    ...
    <b-card title="Market question">
      <div class="market-question">
        Will <b-form-input
          v-model="horse"
          class="inline-input"
          placeholder="Single Horse's Name"
          :state="$v.horse.$dirty ? !$v.horse.$error : null"
...
export default {
  name: 'SportsHorseRacingBinaryOne',
  ...
  validations: {
    ...
    form: ['horse', 'year', 'event', 'closeDate', 'closeTime', 'expiryDate', 'expiryTime']
  }
}
</script>
