...
export default {
  name: 'TradingMetalsBinaryQuestionTwo',
  ...
  data () {
    return {
      pair: null,
      pairOptions: [
        { value: null, text: 'Stock' },
        {
          label: 'Alphabet Inc (Google)',
          options: [
            { value: 'NASDAQ-GOOG', text: 'NASDAQ-GOOG' }
          ]
        },
        {
          label: 'Apple Inc',
          options: [
            { value: 'NASDAQ-AAPL', text: 'NASDAQ-AAPL' }
          ]
        },
        {
          label: 'Tesla Inc',
          options: [
            { value: 'NASDAQ-TSLA', text: 'NASDAQ-TSLA' }
          ]
        }
      ],
      price: '',
      ...
      source: null,
      sourceOptions: {
        'NASDAQ-GOOG': ['GOOG (stock - NASDAQ)'],
        'NASDAQ-AAPL': ['AAPL (stock - NASDAQ)'],
        'NASDAQ-TSLA': ['TSLA (stock - NASDAQ)']
      }
    }
  },
  ...
  computed: {
    ...
    expiryDate () {
      if (this.closeDate) {
        return format(addDays(new Date(this.closeDate), 1), 'yyyy-MM-dd')
      }
