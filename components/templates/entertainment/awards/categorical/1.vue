  ...
  <div>
    <b-card title="Market question">
      <div class="market-question">
        Who will host the <b-form-select
          v-model="year"
          class="inline-input"
...
export default {
  name: 'EntertainmentAwardsCategoricalOne',
  ...
  data () {
    return {
      ...
      requiredOutcomes: ['Multiple Hosts', 'Other'],
      timezone: 'Etc/GMT'
    }
  },
  ...
  validations: {
    ...
    form: ['year', 'event', 'outcomes', 'expiryDate', 'expiryTime']
  }
}
</script>
